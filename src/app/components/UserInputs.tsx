...
export default function UserInputs({ onChange, userInput }: Readonly<UserInputsProps>) {
    return (
        <div className="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <Input id="reductionIntensity" type="radio" value={userInput.reductionIntensity} onChange={onChange}>Reduction intesity</Input>
            ...
            <Input id="pal" type="number" value={userInput.pal} tooltipText={PAL_TOOLTIP} onChange={onChange}>PAL</Input>
